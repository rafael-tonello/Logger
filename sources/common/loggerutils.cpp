...
vector <string> LoggerUtils::validProxies;
...
// // string LoggerUtils::findAndReplaceAll(std::string data, std::string toSearch, std::string replaceStr)
// // {
...
// void LoggerUtils::initializeProxyList()
// {
...
//     LoggerUtils::proxyListInitializedState = 'b';
...
//                 string result = LoggerUtils::ssystem("curl -x "+proxy+" --connect-timeout 5 -sS \"https://www.google.com\" --output \"/tmp/proxyCheckResult\"");
//                 if (result == "")
//                 {
//                     UtilsValidProxiesListLock.lock();
//                     LoggerUtils::validProxies.push_back(proxy);
...
// string LoggerUtils::downloadWithRandomProxy(string url, string destFileName, int maxTries)
// {
//     if (LoggerUtils::proxyListInitializedState == 'a')
//     {
//         LoggerUtils::initializeProxyList();
//     }

//     while (LoggerUtils::validProxies.size() == 0)
//         usleep(10000);
...
//     while (maxTries > 0)
//     {
//         randomProxy = LoggerUtils::validProxies[rand() % LoggerUtils::validProxies.size()];

//         result = LoggerUtils::ssystem("curl -x "+randomProxy+" -sS \""+url+"\" --connect-timeout 25 --output \""+destFileName+"\"");
//         if (result == "")
//         {
//             return result;
//         }
