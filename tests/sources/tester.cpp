...
int Tester::runTests(vector<Tester*> testers, int argc, char* argv[], string whatProjectAreBeingTested)
{
    ...
    cout << endl << "Final statistics: "<< to_string(Tester::testsPassed + Tester::testsFailed) <<" tests perfomed, where " << Tester::testsPassed << " passed and " << Tester::testsFailed << " failed." << endl << flush;
